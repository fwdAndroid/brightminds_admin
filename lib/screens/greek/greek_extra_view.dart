...
class GreekExtraViews extends StatefulWidget {
  String categoryName;
  String image;
  String id;
  String level;
  ...
  @override
  State<GreekExtraViews> createState() => _GreekExtraViewsState();
}

class _GreekExtraViewsState extends State<GreekExtraViews> {
  @override
