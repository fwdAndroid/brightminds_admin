...
class AddExtraExcersiseScreen extends StatefulWidget {
  String level;
  String categoryName;
  AddExtraExcersiseScreen(
      {super.key, required this.level, required this.categoryName});

  @override
  State<AddExtraExcersiseScreen> createState() =>
      _AddExtraExcersiseScreenState();
}

class _AddExtraExcersiseScreenState extends State<AddExtraExcersiseScreen> {
  @override
                    ...
                    child: SaveButton(
                      ...
                      onTap: () async {
                        if (serviceNameController.text.isEmpty ||
                          ...
                          await Database().addExtraExercise(
