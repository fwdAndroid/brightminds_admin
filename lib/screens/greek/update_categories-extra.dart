...
class UpdateCategoriesExtras extends StatefulWidget {
  String categoryName;
  String image;
  String id;
  UpdateCategoriesExtras(
      {super.key,
      required this.id,
  ...
  @override
  State<UpdateCategoriesExtras> createState() => _UpdateCategoriesExtrasState();
}

class _UpdateCategoriesExtrasState extends State<UpdateCategoriesExtras> {
  @override
